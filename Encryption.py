...
def crypting():
    class ApexCryptingGUI(QWidget):
        def __init__(self):
            super().__init__()
            self.setWindowTitle("SecureOak GUI")
            ...
            self.input_text.setStyleSheet(
                "background-color: #404040; color: #ffffff; padding: 8px; border-radius: 8px; border: 1px solid #555555;")  # Input field style
            ...
            self.encrypt_button.setStyleSheet(
                "background-color: #007bff; color: white; padding: 10px; border-radius: 8px;")  # Modern button
            ...
            self.encrypted_output.setStyleSheet(
                "background-color: #404040; color: #00ffcc; padding: 8px; border-radius: 8px; border: 1px solid #555555;")  # Output style
            ...
            self.decrypt_button.setStyleSheet(
                "background-color: #28a745; color: white; padding: 10px; border-radius: 8px;")
            ...
            self.decrypted_output.setStyleSheet(
                "background-color: #404040; color: #ffcc00; padding: 8px; border-radius: 8px; border: 1px solid #555555;")
